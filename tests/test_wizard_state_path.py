...
# Re-baselined 2026-05-15 after A32 (balancing CfD/Merchant split),
# A33 (annual land-lease formula), A34 (PV O&M Year-3-Onwards escalation),
# A36 (gas major maintenance discrete-event schedule replacing level-annual).
# Engine S+B opex lifetime now £89.4k vs Excel £89.2k (was +£9.4k over).
EXPECTED_COMBINED = 0.0878
EXPECTED_SB = 0.0882
EXPECTED_GAS = 0.1413
